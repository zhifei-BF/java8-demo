...
public class TestMethodRef {
    ...
    public void test3() {
        ...
        System.out.println(fun.apply(2.3, 2.24));

        System.out.println("---------------------------------------------");

        BiFunction<Double, Double, Double> fun2 = (x, y) -> Math.max(x, y);
        System.out.println(fun2.apply(1.1, 1.2));
    }
